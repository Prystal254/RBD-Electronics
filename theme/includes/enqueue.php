<?php
	...
	function enqueue_stuff() {
		...
		$enqueList = [	
			...
			[
				"name" => 'slick-lightbox-css', 
				"type" => 'css',
				"path" => 'https://cdnjs.cloudflare.com/ajax/libs/slick-lightbox/0.2.12/slick-lightbox.css',
				"version" => '0.2.12'
			],
			[
			...
			[
				"name" => 'slick-lightbox.js', 
				"type" => 'js',
				"path" => 'https://cdnjs.cloudflare.com/ajax/libs/slick-lightbox/0.2.12/slick-lightbox.min.js',
				"version" => '0.2.12',
				"loadInFooter" => false
			],
			[
